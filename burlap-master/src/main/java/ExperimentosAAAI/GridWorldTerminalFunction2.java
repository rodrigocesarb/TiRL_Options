 ...
 *
 */
public class GridWorldTerminalFunction2 implements TerminalFunction {

	/**
	 * The set of positions marked as terminal positions.
	 */
	protected Set<IntPair> terminalPositions = new HashSet<GridWorldTerminalFunction2.IntPair>();
	
	/**
	 * Initializes without any terminal positions specified.
	 */
	public GridWorldTerminalFunction2(){
	 ...
	 */
	public GridWorldTerminalFunction2(int x, int y){
	 ...
	 */
	public GridWorldTerminalFunction2(IntPair...terminalPositions){
	...
	public boolean isTerminal(State s) {
		int x = ((GridWorldState2)s).agent.x;
		int y = ((GridWorldState2)s).agent.y;
		return this.terminalPositions.contains(new IntPair(x, y));
	}
