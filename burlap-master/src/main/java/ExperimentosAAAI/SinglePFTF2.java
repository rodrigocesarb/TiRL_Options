 ...
 *
 */
public class SinglePFTF2 implements TerminalFunction {
	 ...
	 */
	public SinglePFTF2(PropositionalFunction pf){
		this.pf = pf;
	 ...
	 */
	public SinglePFTF2(PropositionalFunction pf, boolean terminateOnTrue){
		this.pf = pf;
