 ...
 */
@DeepCopyState
public class GridLocation2 implements ObjectInstance {
	...
	public GridLocation2() {
	}

	public GridLocation2(int x, int y, String name) {
		this.x = x;
		this.y = y;
		this.name = name;
	}
	...
	public GridLocation2(int x, int y, int type, String name) {
		this.x = x;
		this.y = y;
		this.type = type;
		this.name = name;
	...
	@Override
	public GridLocation2 copyWithName(String objectName) {
		GridLocation2 nloc = this.copy();
	...
	@Override
	public GridLocation2 copy() {
		return new GridLocation2(x, y, type, name);
	}
