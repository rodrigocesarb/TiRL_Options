 ...
 */
@DeepCopyState
public class GridAgent2 implements ObjectInstance {
	...
	public GridAgent2(int x, int y) {
		this();
		this.x = x;
		this.y = y;
	}

	public GridAgent2(int x, int y, String name) {
		this.x = x;
		this.y = y;
		this.name = name;
	}
	...
	@Override
	public GridAgent2 copyWithName(String objectName) {
		GridAgent2 nagent = this.copy();
	...
	@Override
	public GridAgent2 copy() {
		return new GridAgent2(x, y, name);
	}
