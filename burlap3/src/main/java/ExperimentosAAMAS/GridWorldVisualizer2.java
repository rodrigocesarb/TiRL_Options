 ...
 *
 */
public class GridWorldVisualizer2 {
    
    private GridWorldVisualizer2() {
        // do nothing
    }
	...
	public static StateRenderLayer getRenderLayer(Domain d, int [][] map){
		...
		oopainter.addObjectClassPainter(GridWorldDomain2.CLASS_LOCATION, new LocationPainter(map));
//		oopainter.addObjectClassPainter(GridWorldDomain2.CLASS_GOLD, new CellPainter(2, Color.yellow, map));     //antigo
		oopainter.addObjectClassPainter(GridWorldDomain2.CLASS_GOLD, new GoldPainter(map));  //novo codigo
		oopainter.addObjectClassPainter(GridWorldDomain2.CLASS_AGENT, new CellPainter(1, Color.gray, map));
...
//		oopainter.addObjectClassPainter(GridWorldDomain2.CLASS_GOLD, new CellPainter(2, Color.yellow, map)); //antigo
	...
	public static class GoldPainter implements ObjectPainter{
