 ...
 *
 */
public class QLearning2 extends MDPSolver implements QProvider, LearningAgent, Planner{
	...
	public double runLearningEpisodeWithHash2(Environment env, int maxSteps) {
		State initialState = env.currentObservation();
