 ...
 *
 */
public class SingleGoalPFRF2 implements RewardFunction {

	PropositionalFunction			pf;
	double							goalReward;
	double							nonGoalReward;

	GridWorldDomain2 gwd2;
	 ...
	 */
	public SingleGoalPFRF2(PropositionalFunction pf){
		this.pf = pf;
		this.goalReward = 1.;
	 ...
	 */
	public SingleGoalPFRF2(PropositionalFunction pf, double goalReward, double nonGoalReward){
		this.pf = pf;
