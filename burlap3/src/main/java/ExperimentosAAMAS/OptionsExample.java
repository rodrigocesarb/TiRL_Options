...
public class OptionsExample {
	...
	public static Episode optionExecuteResult(SADomain domain, Option o, State s){
		...
		EnvironmentOptionOutcome eo = o.control(env, 0.9);
		return eo.episode;
	}
	...
	public static void optionComparison(){
		...
		final Option gold1 = createRoomOption("opt1", domain, 4, 10, 0, 0, 10, 10);
		final Option gold2 = createRoomOption("opt2", domain, 9, 3, 0, 0, 10, 10);
		final Option gold3 = createRoomOption("opt3", domain, 10, 5, 0, 0, 10, 10);
		...
		LearningAgentFactory noOptions = new LearningAgentFactory() {
			...
			public LearningAgent generateAgent() {
				return new QLearning(domain, 0.9, new SimpleHashableStateFactory(), qinit, lr);
			}
		};
		
		
		LearningAgentFactory sarsa = new LearningAgentFactory() {

			public String getAgentName() {
				return "Sarsa-Learning";
			}


			public LearningAgent generateAgent() {
				return new SarsaLam(domain, 0.9, new SimpleHashableStateFactory(), qinit, lr, lr);
			}
		};
		...
		LearningAgentFactory allOptons = new LearningAgentFactory() {
			...
			public LearningAgent generateAgent() {
				QLearning ql = new QLearning(domain, 0.9, new SimpleHashableStateFactory(), qinit, lr);
		...
		LearningAlgorithmExperimenter exp = new LearningAlgorithmExperimenter(env, 10, 100, noOptions, sarsa, allOptons, usefulOptions, idealOptions);
		...
		LearningAlgorithmExperimenter exp2 = new LearningAlgorithmExperimenter(env, 10, 100, noOptions, sarsa, allOptons, usefulOptions, idealOptions);
