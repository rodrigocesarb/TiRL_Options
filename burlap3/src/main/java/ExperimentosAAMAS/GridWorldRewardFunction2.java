 ...
 *
 */
public class GridWorldRewardFunction2 implements RewardFunction {
	 ...
	 */
	public GridWorldRewardFunction2(int width, int height, double initializingReward){
	 ...
	 * @param height the height of the grid world
	 */
	public GridWorldRewardFunction2(int width, int height){
		this(width, height, 0.);
	}
