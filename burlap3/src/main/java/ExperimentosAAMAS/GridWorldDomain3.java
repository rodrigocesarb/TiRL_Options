 ...
 *
 */
public class GridWorldDomain3 implements DomainGenerator {
	 ...
	 */
	public GridWorldDomain3(int width, int height){
		this.width = width;
		this.height = height;
	 ...
	 */
	public GridWorldDomain3(int [][] map){
		this.setMap(map);
		this.setDeterministicTransitionDynamics();
	}
...
//		verticalWall(7,7,4);
	...
	public class WallToPF extends PropositionalFunction{
		...
		public WallToPF(String name, String[] parameterClasses, int direction) {
			super(name, parameterClasses);
			int [] dcomps = GridWorldDomain3.this.movementDirectionFromIndex(direction);
			xdelta = dcomps[0];
			ydelta = dcomps[1];
		}
		...
		public boolean isTrue(OOState st, String... params) {
			...
			if(cx < 0 || cx >= GridWorldDomain3.this.width || cy < 0 || cy >= GridWorldDomain3.this.height || GridWorldDomain3.this.map[cx][cy] == 1 || 
					(xdelta > 0 && (GridWorldDomain3.this.map[ax][ay] == 3 || GridWorldDomain3.this.map[ax][ay] == 4)) || (xdelta < 0 && (GridWorldDomain3.this.map[cx][cy] == 3 || GridWorldDomain3.this.map[cx][cy] == 4)) ||
					(ydelta > 0 && (GridWorldDomain3.this.map[ax][ay] == 2 || GridWorldDomain3.this.map[ax][ay] == 4)) || (ydelta < 0 && (GridWorldDomain3.this.map[cx][cy] == 2 || GridWorldDomain3.this.map[cx][cy] == 4)) ){
				return true;
			}
	...
	public static void main(String[] args) {
		...
		GridWorldDomain3 gwdg = new GridWorldDomain3(11, 11);
		...
		GridWorldState s = new GridWorldState(new GridAgent(0, 0), new GridLocation(10, 10, "loc0")); //objetivo na 10,10 e agente na 0,0
