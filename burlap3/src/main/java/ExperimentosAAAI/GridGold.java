 ...
 */
@DeepCopyState
public class GridGold implements ObjectInstance {
	...
	public GridGold(int x, int y, String name) {
		this.x = x;
		this.y = y;
		this.name = name;
	}
	...
	public GridGold(int x, int y, int type, String name) {
		this.x = x;
		this.y = y;
		this.type = type;
		this.name = name;
	...
	public String className() {
		return GridWorldDomain2.CLASS_GOLD;
	}
	...
	@Override
	public GridGold copyWithName(String objectName) {
		GridGold nloc = this.copy();
	...
	@Override
	public GridGold copy() {
		return new GridGold(x, y, type, name);
	}
