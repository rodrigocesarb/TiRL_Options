...
public class QLearningExample extends MDPSolver implements LearningAgent, QProvider {
	...
	public QLearningExample(SADomain domain, double gamma, HashableStateFactory hashingFactory,
	...
	public static void main(String[] args) {
		...
		//create Q-learning
		QLearningExample agent = new QLearningExample(domain, 0.99, new SimpleHashableStateFactory(),
