 ...
 *
 */
public interface Option2 extends Action{

	/**
	 * Returns true if the input state is in the initiation set of the {@link Option2}
	...
	class Helper{
		public static EnvironmentOptionOutcome control(Option2 o, Environment env, double discount){
