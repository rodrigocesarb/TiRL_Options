...
public class MOOption extends SubgoalOption{
	...
	public void salvaArquivo(String caminho) throws IOException{
		...
		ObjectOutputStream oos = new ObjectOutputStream(fos);
			...
			oos.writeObject(this.hasher);
		
		oos.close();
	}
	
	public static MOOption carregaArquivo(){
		return new MOOption(name,option,hasher);
	}
